...
$sql = mysqli_query($conn,"SELECT * FROM usuarios WHERE login='$dato'");
...
if($result){
    $row = $result;
                         echo' <p >
                               ...
                               <form  method="POST" action="crudUser.php" autocomplete="on" size=100> 
                               <p>
							   <label> Login:    </label> 
                               <input id="login" name="login" required="required" type="text" value="'.$row[1].'" readonly />
                               </p>                              
                               <p>
                               <label> Password:    </label> 
                               <input id="password" name="password" required="required" type="text" value="'.$row[2].'" />
                               </p>
	                           <p> 
                               <label> Name:    </label> 
                               <input id="name" name="name" required="required" type="text" value="'.$row[3].'" /></p>
                               <p>           
                               <label> LastName:    </label>
                               <input id="lastname" name="lastname" required="required" type="text" value="'.$row[4].'" /></p>
                               </p>
                               <p> 
                               <label>Type:   </label><br>
                               <input type="radio" name="type" value="'.$row[5].'"checked>'.$row[5].'<br>';
                               if($row[5]=="user"){$a="admin";}else{$a="user";}
                               echo '<input type="radio" name="type" value="'.$a.'">'.$a.'  
                               </p>
